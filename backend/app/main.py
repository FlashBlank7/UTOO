...
from app.api.v1 import auth, posts, comments, admin, agent, reports, schools, boards, school_requests
...
app.include_router(school_requests.router, prefix="/api/v1/school-requests", tags=["school-requests"])
